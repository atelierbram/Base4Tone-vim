" File: https://github.com/atelierbram/Base4Tone-vim/blob/master/autoload/lightline/Base4Tone_Classic_C.vim
" by: Bram de Haan
...
" condition vim-colors-Base4Tone_Classic_C uses to determine which set of colors  
" to use. 
 let s:Base4Tone_Classic_C_termcolors = get(g:, 'Base4Tone_Classic_C_termcolors', 256) 
 if s:Base4Tone_Classic_C_termcolors != 256 && &t_Co >= 16 
   let s:cuiindex = 0 
 elseif s:Base4Tone_Classic_C_termcolors == 256 
   let s:cuiindex = 1 
 else 
   let s:cuiindex = 2 
 endif 
...
let s:orange = [ '#18d88e', s:cuicolors.orange[s:cuiindex] ] 
let s:red = [ '#9f6404', s:cuicolors.red[s:cuiindex] ] 
let s:magenta = [ '#b9cf17', s:cuicolors.magenta[s:cuiindex] ] 
let s:violet = [ '#8d9f04', s:cuicolors.violet[s:cuiindex] ] 
let s:blue = [ '#d5880b', s:cuicolors.blue[s:cuiindex] ] 
let s:cyan = [ '#038654', s:cuicolors.cyan[s:cuiindex] ] 
let s:green = [ '#16ca85', s:cuicolors.green[s:cuiindex] ] 
...
let g:lightline#colorscheme#Base4Tone_Classic_C#palette = lightline#colorscheme#flatten(s:p) 
